			...
			?>
				...
				<thead>
					...
					while($row = mysqli_fetch_array($result))
					{
						...
						echo "<td>";
								?>
								<input type="text" class="some_class" value="" name="checkout" id="some_class_1"/>
								
						<?php echo "</td>";
						echo "<td>";
								?><a href="checkoutcode.php?id=<?php echo $row['room_id']; ?>&custid=<?php echo $row['cust_id']; ?>">Checkout</a><?php
						echo "</td>";
