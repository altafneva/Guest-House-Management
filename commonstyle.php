...
<head>
                    ...
                    <aside class="left-side sidebar-offcanvas">
                        ...
                        <li class="active">
                            <a href="customer.html">
                                <i class="fa fa-gavel"></i> <span>Customer</span>
                            </a>
                        </li>
	...
	$con = mysql_connect("localhost","root","");
		if($con)
		{
				...
				$result1 = mysql_query("SELECT * FROM tbl_room ");
				if($result1)
				{
					...
					while($row = mysql_fetch_array($result1))
					{
						...
						<div class="col-md-3">
                            <div class="sm-st clearfix">
							   ...
							   <div class="sm-st-info">
							   <span><a href="customer.php?roomno=<?php echo $row['room_no']; ?>&roomtype=<?php echo $row['room_type'] ?>"><?php echo $row['room_no']; echo $row['room_type'];?></a></th>
								</span>
                                    </div>
                            </div>
                        </div>
					...
					while($row = mysql_fetch_array($result))
					{
						...
						<div class="col-md-3">
                            <div class="sm-st clearfix">
							   ...
							   <div class="sm-st-info">
							    <span><a href="customer.php?roomno=<?php echo $row['room_no']; ?>&roomtype=<?php echo $row['room_type'] ?>" rel="flashfg[blue]"><?php echo $row['room_no']; echo $row['room_type']; ?></a>
									</span>
                                    </div>
                            </div>
                        </div>
